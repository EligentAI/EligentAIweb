...
import { Menu, X, Zap, Sun, Moon, Globe, Check } from "lucide-react";
      ...
      >
        <nav className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-[72px]">
            {/* Logo */}
            <button onClick={() => handleNavClick("#home")} className="flex items-center gap- group">
            ...
            <div className="hidden lg:flex items-center gap-2">
              ...
              <button
                ...
                className="btn-primary px-5 py-2.5 text-[13px] font-syne font-semibold rounded-xl ml-1"
              >
                {t.nav.bookDemo}
              </button>
            </div>
          ...
          >
            <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col gap-1">
              ...
              <div className="mt-2">
                <button
                  onClick={() => handleNavClick("#contact")}
                  className="btn-primary w-full py-3 text-[14px] font-syne font-semibold rounded-xl"
                >
                  {t.nav.bookDemo}
                </button>
              </div>
